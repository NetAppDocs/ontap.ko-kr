...
summary: '디스크 인증 패키지(DQP)는 새로 인증된 드라이브에 대한 완벽한 지원을 제공합니다. 드라이브 펌웨어를 업데이트하거나 클러스터에 새로운 드라이브 유형 또는 크기를 추가하기 전에 DQP를 업데이트해야 합니다. 또한 DQP를 정기적으로 업데이트하는 것이 좋습니다.' 
---
