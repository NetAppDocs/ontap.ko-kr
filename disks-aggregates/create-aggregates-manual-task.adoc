...
및 집계 생성 옵션 및 요구 사항에 대한 자세한 `storage aggregate create` 내용은 을 link:https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-create.html["ONTAP 명령 참조입니다"^]참조하십시오.
