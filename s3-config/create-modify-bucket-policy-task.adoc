...
ONTAP 9.19.1부터 조건을 사용하여 객체 업로드에 대한 조건부 쓰기 및 객체 삭제에 대한 조건부 삭제를 적용할 수 있습니다. 조건부 쓰기 및 삭제는 객체의 덮어쓰기 또는 의도하지 않은 삭제를 방지하는 방법을 제공합니다.
...
----
ONTAP 9.19.1부터 조건을 사용하여 객체 업로드에 대한 조건부 쓰기 및 객체 삭제에 대한 조건부 삭제를 적용할 수 있습니다. 다음 예는 bucket1에 대한 조건부 쓰기를 적용하는 버킷 정책 문 조건을 생성합니다.
