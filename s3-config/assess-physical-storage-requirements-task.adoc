...
.이 작업에 대해
S3가 활성화된 SVM에서 S3 버킷을 생성할 때 FlexGroup 볼륨이 link:../s3-config/architecture.html#automatic-flexgroup-sizing-with-ontap-9-14-1-and-later["자동으로 생성됩니다"] 해당 버킷을 지원하도록 설정됩니다. ONTAP에서 기본 애그리게이트 및 FlexGroup 구성 요소를 자동으로 선택하도록 하거나(기본값) 기본 애그리게이트 및 FlexGroup 구성 요소를 직접 선택할 수 있습니다.
...
* https://www.netapp.com/pdf.html?item=/media/17251-tr4571a.pdf["NetApp 기술 보고서 4571-A: NetApp ONTAP FlexGroup 볼륨 모범 사례"^]
