...
* 모든 로드 공유 미러 관계
+
부하 분산 관계 삭제에 대한 자세한 내용은 link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship["부하 분산 미러링 관계를 제거하는 방법"]을 참조하십시오.
