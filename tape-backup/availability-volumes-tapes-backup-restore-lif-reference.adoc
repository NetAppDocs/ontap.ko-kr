...
summary: 클러스터 내의 모든 LIF 유형에 대해 NDMP 제어 연결을 설정하도록 백업 애플리케이션을 구성할 수 있습니다. 스토리지 가상 머신 범위의 NDMP 모드에서는 이러한 LIF 유형과 CAB 확장 상태에 따라 백업 및 복원 작업에 사용할 수 있는 볼륨 및 테이프 장치의 가용성을 확인할 수 있습니다. 
---
