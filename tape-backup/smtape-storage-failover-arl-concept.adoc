...
summary: SMTape 백업 또는 복원 작업을 수행하기 전에 스토리지 페일오버 또는 애그리게이트 재배치 작업과 이러한 작업이 어떻게 연동되는지 이해해야 합니다. -override-vetoes 옵션은 스토리지 페일오버 또는 ARL 작업 중 SMTape 엔진의 동작 방식을 결정합니다. 
---
