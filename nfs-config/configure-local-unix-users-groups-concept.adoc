...
summary: SVM에서 로컬 UNIX 사용자 및 그룹을 사용하여 인증 및 이름 매핑을 수행할 수 있습니다. UNIX 사용자 및 그룹을 수동으로 생성하거나, uniform resource identifier에서 UNIX 사용자 또는 그룹이 포함된 파일을 로드할 수 있습니다. 
---
