...
summary: 개별 로컬 UNIX 그룹을 수동으로 생성하는 대신, vserver services name-service unix-group load-from-uri 명령을 사용하여 Uniform Resource Identifier에서 로컬 UNIX 그룹 목록을 SVM으로 로드할 수 있습니다. 
---
