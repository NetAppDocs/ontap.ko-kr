...
summary: 넷그룹은 사용자 인증 및 엑스포트 정책 규칙에서 클라이언트를 일치시키는 데 사용할 수 있습니다. 외부 네임 서버에서 넷그룹에 대한 액세스를 제공하거나 vserver services name-service netgroup load 명령을 사용하여 Uniform Resource Identifier에서 SVM으로 넷그룹을 로드할 수 있습니다. 
---
