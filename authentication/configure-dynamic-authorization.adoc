...
ONTAP 명령 참조에서 https://docs .NetApp.com/us-en/ONTAP-cli/security-dynamic-authorization-user-trust-score-reset.html 명령 링크에 대해 자세히[`security dynamic-authorization user-trust-score reset` 알아보십시오.
