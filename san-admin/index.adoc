...
.를 참조하십시오
ASA r2 스토리지 시스템(ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30 또는 ASA A20)이 있는 경우 link:https://docs.netapp.com/us-en/asa-r2/index.html["ASA R2 스토리지 시스템 설명서"^]을 참조하십시오.
