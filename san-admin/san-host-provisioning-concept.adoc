...
summary: SAN 환경에서 스토리지 시스템은 스토리지 타겟 장치를 가진 대상입니다. iSCSI 및 FC의 경우 스토리지 타겟 장치를 LUN이라고 합니다. Fibre Channel을 통한 Non-Volatile Memory Express의 경우 스토리지 타겟 장치를 네임스페이스라고 합니다. 
---
