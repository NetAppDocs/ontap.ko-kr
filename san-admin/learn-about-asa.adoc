...
summary: NetApp 올플래시 SAN 어레이는 ONTAP 9.7부터 사용 가능합니다. ASA는 검증된 AFF NetApp 플랫폼을 기반으로 구축된 올플래시 SAN 전용 솔루션입니다. 
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["NetApp 기술 보고서 4080: 최신 SAN에 대한 모범 사례"^]
