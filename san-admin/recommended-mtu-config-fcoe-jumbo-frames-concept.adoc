...
summary: Fibre Channel over Ethernet의 경우 CNA의 이더넷 어댑터 부분에 대한 점보 프레임은 9000 MTU로 구성해야 합니다. CNA의 FCoE 어댑터 부분에 대한 점보 프레임은 1500 MTU보다 크게 구성해야 합니다. 이니시에이터, 타겟 및 모든 중간 스위치가 점보 프레임을 지원하고 점보 프레임에 대해 구성된 경우에만 점보 프레임을 구성하십시오. 
---
