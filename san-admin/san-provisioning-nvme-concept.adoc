...
summary: ONTAP 9.4부터 SAN 환경에서 NVMe FC가 지원됩니다. NVMe FC를 통해 스토리지 관리자는 네임스페이스와 서브시스템을 프로비저닝한 다음 FC 및 iSCSI용 LUN을 프로비저닝하고 igroup에 매핑하는 방식과 유사하게 네임스페이스를 서브시스템에 매핑할 수 있습니다. 
---
= NVMe를 이용한 SAN 프로비저닝
:allow-uri-read: 
:icons: font
...
.관련 정보
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["NetApp 기술 보고서 4684: NVMe/FC를 사용하여 최신 SAN 구현 및 구성"^]
