...
summary: 심볼 링크는 UNIX 환경에서 생성되는 파일로, 다른 파일이나 디렉터리에 대한 참조를 포함합니다. 클라이언트가 심볼 링크에 액세스하면 해당 심볼 링크가 가리키는 대상 파일이나 디렉터리로 리디렉션됩니다. ONTAP는 와이드링크를 포함하여 상대 및 절대 심볼 링크를 지원합니다. 
---
