...
summary: 스토리지 가상 머신의 볼륨에 포함된 파일 및 디렉터리의 파일 보안 정보를 표시할 수 있습니다. FlexVol 볼륨의 감사 정책 정보를 표시할 수 있습니다. 구성된 경우 FlexVol 볼륨의 스토리지 수준 액세스 가드 및 동적 액세스 제어 보안 설정 정보를 표시할 수 있습니다. 
---
