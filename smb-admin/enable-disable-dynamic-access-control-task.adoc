...
summary: CIFS 서버의 객체를 보호하기 위해 Dynamic Access Control을 사용할 수 있도록 하는 옵션은 기본적으로 비활성화되어 있습니다. CIFS 서버에서 Dynamic Access Control을 사용하려면 이 옵션을 활성화해야 합니다. 나중에 CIFS 서버에 저장된 객체를 보호하기 위해 Dynamic Access Control을 사용하지 않기로 결정한 경우 이 옵션을 비활성화할 수 있습니다. 
---
