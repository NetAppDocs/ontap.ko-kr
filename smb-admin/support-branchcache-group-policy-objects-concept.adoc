...
summary: ONTAP BranchCache는 BranchCache 그룹 정책 개체에 대한 지원을 제공하므로 특정 BranchCache 구성 매개 변수를 중앙에서 관리할 수 있습니다. BranchCache에 사용되는 GPO는 두 가지로, Hash Publication for BranchCache GPO와 Hash Version Support for BranchCache GPO입니다. 
---
