...
summary: 'CIFS 서버에서 Group Policy Object 지원을 설정하거나 해제할 수 있습니다. CIFS 서버에서 GPO 지원을 설정하면 그룹 정책에 정의된 해당 GPO(CIFS 서버 컴퓨터 개체가 포함된 조직 단위에 적용되는 정책)가 CIFS 서버에 적용됩니다.' 
---
