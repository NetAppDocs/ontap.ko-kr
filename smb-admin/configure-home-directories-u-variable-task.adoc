...
summary: Windows 사용자 이름 변수를 사용하여 공유 이름을 지정하고 UNIX 사용자 이름 변수를 사용하여 홈 디렉토리 공유에 대한 상대 경로를 지정하는 홈 디렉토리 구성을 만들 수 있습니다. 그런 다음 사용자는 홈 디렉토리의 실제 이름이나 경로를 알지 못해도 Windows 사용자 이름을 사용하여 동적으로 생성된 공유를 통해 홈 공유에 연결할 수 있습니다. 
---
