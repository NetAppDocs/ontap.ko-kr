...
summary: NAS 환경에서 파일 액세스를 관리하려면 스토리지 가상 머신의 데이터 볼륨과 접합점을 관리해야 합니다. 여기에는 네임스페이스 아키텍처 설계, 접합점 유무에 관계없이 볼륨 생성, 볼륨 마운트 또는 마운트 해제, 데이터 볼륨 및 NFS 서버 또는 CIFS 서버 네임스페이스에 대한 정보 표시 등이 포함됩니다. 
---
