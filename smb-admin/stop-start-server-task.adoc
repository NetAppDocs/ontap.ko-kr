...
summary: SVM에서 CIFS 서버를 중지할 수 있습니다. 이는 사용자가 SMB 공유를 통해 데이터에 액세스하지 않는 동안 작업을 수행할 때 유용할 수 있습니다. CIFS 서버를 시작하여 SMB 액세스를 다시 시작할 수 있습니다. CIFS 서버를 중지하면 스토리지 가상 머신에서 허용되는 프로토콜을 수정할 수도 있습니다. 
---
