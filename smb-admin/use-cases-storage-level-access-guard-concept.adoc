...
summary: Storage-Level Access Guard는 클라이언트 측에서 볼 수 없는 스토리지 레벨에서 추가적인 보안을 제공합니다. 따라서 사용자나 관리자는 자신의 데스크톱에서 이 권한을 취소할 수 없습니다. 스토리지 레벨에서 액세스를 제어하는 기능이 유용한 특정 사용 사례가 있습니다. 
---
