...
summary: NTFS 볼륨 및 혼합 보안 스타일 볼륨에서 NTFS 유효 보안이 적용된 데이터에 대한 Dynamic Access Control 보안 정보를 표시할 수 있습니다. 여기에는 조건부 ACE, 리소스 ACE 및 중앙 액세스 정책 ACE에 대한 정보가 포함됩니다. 이 결과를 사용하여 보안 구성을 검증하거나 파일 액세스 문제를 해결할 수 있습니다. 
---
