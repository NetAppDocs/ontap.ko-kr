...
summary: CIFS 서버의 그룹 정책 개체 구성에 대한 정보를 표시하여 CIFS 서버가 속한 도메인에 BranchCache GPO가 정의되어 있는지, 정의되어 있다면 허용된 설정이 무엇인지 확인할 수 있습니다. 또한 BranchCache GPO 설정이 CIFS 서버에 적용되는지 여부도 확인할 수 있습니다. 
---
