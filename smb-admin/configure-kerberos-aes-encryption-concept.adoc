...
summary: 'Kerberos 기반 통신에서 최고의 보안을 확보하려면 SMB 서버에서 AES-256 및 AES-128 암호화를 활성화할 수 있습니다. SVM에서 SMB 서버를 생성할 때 기본적으로 AES(고급 암호화 표준) 암호화가 비활성화되어 있습니다. AES 암호화에서 제공하는 강력한 보안을 활용하려면 이 기능을 활성화해야 합니다.' 
---
