...
summary: 스토리지 가상 머신에 보안 정책을 적용할 때 보안 정책 작업을 모니터링하여 작업 진행 상황을 모니터링할 수 있습니다. 이는 보안 정책 적용이 성공했는지 확인하려는 경우에 유용합니다. 또한 많은 수의 파일 및 폴더에 대량 보안을 적용하는 장기 실행 작업이 있는 경우에도 유용합니다. 
---
