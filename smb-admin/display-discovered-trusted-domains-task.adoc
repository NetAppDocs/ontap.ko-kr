...
ONTAP 9.13.1부터 ONTAP은 신뢰할 수 있는 도메인에 대한 사이트 검색을 수행하고, 검색된 사이트를 사용하여 해당 도메인의 도메인 컨트롤러를 찾습니다. 이를 통해 DNS SRV 조회 시 신뢰할 수 있는 도메인의 도메인 컨트롤러에 대한 올바른 사이트 정보를 사용할 수 있습니다. 신뢰할 수 있는 도메인에 대한 사이트 검색에 실패하면 ONTAP은 SMB 서버의 기본 사이트를 사용합니다.
