...
summary: Dynamic Access Control ACE가 적용된 ACL이 있는 리소스가 있고 스토리지 가상 머신에서 Dynamic Access Control을 비활성화한 경우, 해당 리소스의 비Dynamic Access Control ACE를 관리하려면 먼저 Dynamic Access Control ACE를 제거해야 합니다. 
---
