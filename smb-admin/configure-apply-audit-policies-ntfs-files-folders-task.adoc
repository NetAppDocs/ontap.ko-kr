...
summary: ONTAP CLI를 사용하여 NTFS 파일 및 폴더에 감사 정책을 적용하려면 몇 가지 단계를 수행해야 합니다. 먼저 NTFS 보안 설명자를 생성하고 해당 설명자에 SACL을 추가합니다. 다음으로 보안 정책을 생성하고 정책 작업을 추가합니다. 마지막으로 스토리지 가상 머신에 보안 정책을 적용합니다. 
---
