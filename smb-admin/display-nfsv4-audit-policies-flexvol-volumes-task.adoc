...
summary: ONTAP CLI를 사용하여 FlexVol 볼륨의 NFSv4 감사 정책에 대한 정보를 표시할 수 있습니다. 여기에는 보안 스타일 및 유효 보안 스타일, 적용된 권한, 시스템 액세스 제어 목록에 대한 정보가 포함됩니다. 이 결과를 사용하여 보안 구성을 검증하거나 감사 관련 문제를 해결할 수 있습니다. 
---
