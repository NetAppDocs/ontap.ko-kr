...
summary: FlexVol 볼륨은 NTFS, UNIX 또는 혼합의 세 가지 보안 스타일 중 하나를 선택할 수 있습니다. 보안 스타일에 관계없이 SMB를 통해 데이터에 액세스할 수 있습니다. 단, UNIX 유효 보안을 사용하여 데이터에 액세스하려면 적절한 UNIX 파일 권한이 필요합니다. 
---
