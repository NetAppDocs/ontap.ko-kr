...
summary: ONTAP 릴리스 주기와 관계없이 ARP/AI 보안 번들을 자동으로 또는 수동으로 업데이트하여 최신 랜섬웨어 위협에 대한 ARP/AI 보호 기능을 최신 상태로 유지하십시오. 
---
...
NOTE: ARP(ONTAP 9.10.1~9.15.1)는 자동 보안 모델 업데이트를 지원하지 않습니다. 보안 탐지 기능은 ONTAP 소프트웨어 업그레이드를 통해서만 업데이트됩니다. ONTAP 9.15.1 이하 버전을 사용 중인 경우 link:index.html["자율형 랜섬웨어 보호에 대해 알아보세요"]을 참조하십시오.
...
NOTE: 의도치 않은 ARP/AI 다운그레이드를 방지하려면 현재 버전보다 최신 버전의 ARP/AI 업데이트만 설치하십시오.
...
.관련 정보
* link:learn-about-arpai.html["ARP/AI에 대해 알아보세요"]
