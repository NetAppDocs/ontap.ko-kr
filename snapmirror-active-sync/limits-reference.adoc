...
IMPORTANT: 이러한 제한 사항은 FAS, AFF 및 최신 ASA 시스템에 적용됩니다. ASA R2 시스템(ASA A1K, ASA A70 또는 ASA A90)을 사용하는 경우 을 참조하십시오.link:https://docs.netapp.com/us-en/asa-r2/data-protection/manage-consistency-groups.html["ASA r2 설명서"^]
...
| 2노드 클러스터당 고유한 LUN | 4,096개 


| 4노드 클러스터당 고유 LUN(ONTAP 9.16.1부터 사용 가능) | 6,144 
