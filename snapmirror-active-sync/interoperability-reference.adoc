...
ONTAP 9.19.1 RC 버전부터 ARP/AI는 SnapMirror 활성 동기화 SAN 관계에 참여하는 기본 볼륨을 지원합니다. 자세한 내용은 link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations["자율 랜섬웨어 보호 사용 사례 및 고려사항"]를 참조하십시오.
