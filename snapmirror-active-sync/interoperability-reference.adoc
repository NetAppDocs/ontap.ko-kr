...
ONTAP 9.19.1부터 ARP/AI는 SnapMirror 활성 동기화 SAN 관계에 참여하는 기본 볼륨을 지원합니다. 자세한 내용은 link:../anti-ransomware/support-arpai.html#arp-ai-and-virtual-machines["자율 랜섬웨어 보호 사용 사례 및 고려사항"]을 참조하십시오.
