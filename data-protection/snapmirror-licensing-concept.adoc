...
+
2019년 6월 이전에 Premium 또는 Flash Bundle로 시스템을 구매한 경우 NetApp Support 사이트에서 필요한 SnapMirror 동기식 라이센스를 얻기 위한 NetApp 라이센스 키를 다운로드할 수 있습니다: https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["라이센스 키"^].
