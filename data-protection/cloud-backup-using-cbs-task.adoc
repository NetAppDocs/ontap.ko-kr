...
. link:https://docs.netapp.com/us-en/bluexp-setup-admin/concept-identity-and-access-management.html["BlueXP를 사용하여 액세스 키와 비밀 키를 생성합니다"^] .
...
BlueXP 인터페이스를 사용할 때만 데이터 복원, 관계 업데이트, 관계 삭제와 같은 백업 관리 작업을 수행할 수 있습니다 . link:https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-backup-manage.html["백업 파일에서 데이터를 복원합니다"^] 자세한 내용은.
