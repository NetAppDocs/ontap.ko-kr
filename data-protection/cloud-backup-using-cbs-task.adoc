...
---
= BlueXP  백업 및 복구 서비스를 사용하여 데이터를 백업합니다
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
NOTE: ONTAP 9.10.1부터 클라우드 백업 공급자로 StorageGRID을 선택할 수 있지만, BlueXP 가 온프레미스에 배포된 경우에만 가능합니다. BlueXP 커넥터는 사내에 설치해야 하며 BlueXP SaaS(Software-as-a-Service) 애플리케이션을 통해 사용할 수 있습니다.
...
* SVM-DR은 지원되지 않습니다.
* BlueXP  백업 및 복구를 사용하여 FlexGroups를 백업할 수 없습니다.
