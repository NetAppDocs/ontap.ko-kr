...
[role="lead"]
ONTAP 9.9.1부터 데이터 보호 워크플로우를 클라우드로 전환할 때 _SnapMirror cloud_를 사용할 수 있습니다. 기존 테이프 백업 아키텍처 대신 객체 스토리지를 장기 데이터 보존 및 아카이빙을 위한 대체 리포지토리로 사용할 수 있습니다. 클라우드 객체 스토어로 Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, StorageGRID 또는 ONTAP S3와 같은 공급자를 사용할 수 있습니다.

ONTAP 9.9.1부터 System Manager를 사용하여 데이터를 백업하고 복원할 수 있습니다.
