...
에 대한 자세한 `snapmirror create` `snapmirror modify` 내용은, 및 `snapmirror restore`link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=snapmirror["ONTAP 명령 참조입니다"^] 을 참조하십시오.
