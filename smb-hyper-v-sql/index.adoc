...
summary: 'ONTAP 기능을 사용하면 SMB 프로토콜을 통해 두 가지 Microsoft 애플리케이션(Microsoft Hyper-V 및 Microsoft SQL Server)에 대해 무중단 운영을 지원할 수 있습니다.' 
---
...
.관련 정보
ONTAP 기술 및 외부 서비스와의 상호 작용에 대한 자세한 내용은 다음 기술 보고서(TR)를 참조하십시오. ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172pdf.pdf["NetApp 기술 보고서 4172: ONTAP 모범 사례를 사용한 SMB 3.0 기반 Microsoft Hyper-V"^]
