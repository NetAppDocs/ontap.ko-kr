...
.관련 정보
ONTAP 기술 및 외부 서비스와의 상호 작용에 대한 자세한 내용은 다음 기술 보고서(TR)를 참조하십시오. ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172.pdf["NetApp 기술 보고서 4172: ONTAP 모범 사례를 사용한 SMB 3.0 기반 Microsoft Hyper-V"^]
