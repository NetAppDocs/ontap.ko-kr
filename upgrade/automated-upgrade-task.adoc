...
NOTE: NetApp 통해 ONTAP 9.15.1 이상으로 업그레이드하는 경우 다음을 따르세요.link:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html["NetApp 콘솔 설명서의 업그레이드 절차"^] .
...
+
<<<<<<< HEAD 익명 FTP의 경우 URL을 +ftp://anonymous@ftpserver+ 형식으로 지정해야 합니다.



[]
=====
익명 FTP의 경우, URL을 \ftp://anonymous@ftpserver 형식으로 지정해야 합니다. >>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
