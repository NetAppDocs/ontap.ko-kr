...
---
= ONTAP 2노드 MetroCluster 구성 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
ONTAP 9.3 이상을 실행하는 2노드 MetroCluster 구성이 있는 경우 link:automated-upgrade-task.html["자동화된 무중단 ONTAP 업그레이드로 ONTAP 이미지를 설치합니다"]의 CLI 단계를 사용하십시오.
