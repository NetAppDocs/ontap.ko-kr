...
sidebar: sidebar 
keywords: use, ldap 
summary: LDAP 서버를 사용하면 사용자 정보를 중앙에서 관리할 수 있습니다. 환경 내의 LDAP 서버에 사용자 데이터베이스를 저장하는 경우 스토리지 시스템을 구성하여 기존 LDAP 데이터베이스에서 사용자 정보를 조회할 수 있습니다. 
---
...
자세한 내용은 https://www.netapp.com/pdf.html?item=/media/19423-tr-4835.pdf["NetApp 기술 보고서 4835: ONTAP에서 LDAP를 구성하는 방법"^]를 참조하십시오.
