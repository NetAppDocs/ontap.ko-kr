...
sidebar: sidebar 
keywords:  
summary: 스토리지 가상 머신에서 NFSv4 리퍼럴을 활성화하려면 -v4-fsid-change 및 -v4.0-referrals 또는 -v4.1-referrals 옵션을 활성화하면 됩니다. NFSv4 리퍼럴을 활성화하면 이 기능을 지원하는 NFSv4 클라이언트의 데이터 액세스 속도가 향상될 수 있습니다. 
---
