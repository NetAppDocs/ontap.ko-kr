...
summary: 내보내기 정책 캐시를 수동으로 플러시하면 오래된 정보가 제거되고 ONTAP가 적절한 외부 리소스에서 최신 정보를 가져오도록 강제할 수 있습니다. 이렇게 하면 NFS 내보내기에 대한 클라이언트 액세스와 관련된 다양한 문제를 해결하는 데 도움이 될 수 있습니다. 
---
