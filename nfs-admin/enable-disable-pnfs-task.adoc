...
summary: pNFS는 NFS 클라이언트가 스토리지 장치에서 읽기/쓰기 작업을 직접 병렬로 수행할 수 있도록 하여 잠재적인 병목 현상으로 작용할 수 있는 NFS 서버를 우회함으로써 성능을 향상시킵니다. pNFS를 활성화 또는 비활성화하려면 -v4.1-pnfs 옵션을 수정하면 됩니다. 
---
