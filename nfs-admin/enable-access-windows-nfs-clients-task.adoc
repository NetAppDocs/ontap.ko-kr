...
summary: ONTAP는 Windows NFSv3 클라이언트의 파일 액세스를 지원합니다. 즉, NFSv3를 지원하는 Windows 운영 체제를 실행하는 클라이언트는 클러스터의 NFSv3 내보내기에 있는 파일에 액세스할 수 있습니다. 이 기능을 성공적으로 사용하려면 스토리지 가상 머신을 올바르게 구성하고 특정 요구 사항 및 제한 사항을 숙지해야 합니다. 
---
