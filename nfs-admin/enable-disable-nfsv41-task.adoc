...
summary: -v4.1 옵션을 수정하여 NFSv4.1을 활성화 또는 비활성화할 수 있습니다. 이를 통해 NFSv4.1 프로토콜을 사용하는 클라이언트의 파일 액세스가 가능합니다. ONTAP 9.9.1에서는 NFSv4.1이 기본적으로 활성화되어 있습니다. 이전 릴리스에서는 기본적으로 비활성화되어 있습니다. 
---
