...
NOTE: MetroCluster 환경에서는 두 클러스터에서 모두 이 명령을 실행해야 합니다.  자세히 알아보세요 `security key-manager setup` 에서link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-setup.html["ONTAP 명령 참조입니다"^] .
...
+
이 절차에 설명된 명령에 대해 자세히 알아보세요.link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-show-key-store.html["ONTAP 명령 참조입니다"^] .
