...
== ONTAP 9.18.1부터 지원되는 기능

* xref:../performance-admin/adaptive-qos-policy-groups-task.html[중첩된 QoS 정책]다음 객체 쌍에 대해 지원됩니다.
+
** SVM에 포함된 SVM 및 FlexGroup 볼륨
** 볼륨 내의 FlexGroup 볼륨 및 Qtree
...
* 다음의 지원되는 기능 등을 포함하는 FlexGroup 볼륨용 xref:../anti-ransomware/index.html[자율 랜섬웨어 보호]:
+
