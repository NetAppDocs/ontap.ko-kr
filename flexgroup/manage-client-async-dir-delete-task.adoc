...
link:fast-directory-delete-asynchronous-task.html#delete-directories-asynchronously["ONTAP를 사용하여 FlexVol 및 FlexGroup 볼륨에서 디렉터리를 비동기적으로 삭제하는 방법에 대해 알아보십시오."].
...
.단계
. 클러스터 CLI에서 고급 권한 모드로 들어갑니다: `-privilege advanced`
