...
* System Manager를 사용하여 FlexGroup 볼륨을 생성하면 ONTAP FlexGroup 볼륨을 생성하는 데 필요한 로컬 계층을 자동으로 선택합니다.
...
====
.관련 정보
https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp 기술 보고서 4571: NetApp FlexGroup 모범 사례 및 구현 가이드"^]
