...
summary: ONTAP 9.16.1부터 NVMe TCP 연결에 대한 TLS 보안 채널을 활성화 및 비활성화할 수 있습니다. 
---
...
[role="lead"]
ONTAP 9.16.1 버전부터 NVMe/TCP 연결에 대한 TLS 보안 채널을 구성할 수 있습니다.  System Manager 또는 ONTAP CLI를 사용하여 TLS가 활성화된 새 NVMe 서브시스템을 추가하거나 기존 NVMe 서브시스템에 대해 TLS를 활성화할 수 있습니다.  ONTAP 9.19.1 버전부터는 TLS 하드웨어 오프로드가 지원됩니다.
