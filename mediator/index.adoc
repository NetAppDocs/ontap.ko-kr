...
[CAUTION]
====
* ONTAP Mediator가 MetroCluster IP 구성에서 HTTPS 프로토콜로 구성된 경우, 단일 ONTAP Mediator 인스턴스는 하나의 MetroCluster IP 구성만 모니터링할 수 있습니다. 여러 MetroCluster IP 구성을 동시에 모니터링하는 것은 지원되지 않습니다.
