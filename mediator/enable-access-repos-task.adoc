...
.Oracle Linux 10.x 운영 체제용 절차
[#OL10x%collapsible]
====
운영 체제가 *Oracle Linux 10.x*인 경우 이 절차를 사용하여 리포지토리에 대한 액세스를 활성화하십시오.
...
====
.Oracle Linux 9.x 운영 체제용 절차
[#OL9x%collapsible]
====
운영 체제가 *Oracle Linux 9.x*인 경우 이 절차를 사용하여 리포지토리에 대한 액세스를 활성화하십시오.
