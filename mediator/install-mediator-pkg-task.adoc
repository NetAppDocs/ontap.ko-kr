...
summary: ONTAP Mediator를 설치하려면 설치 패키지를 받아서 호스트에서 설치 프로그램을 실행해야 합니다. 
---
...
NOTE: 설치 중 서명 확인을 건너뛰려면 다음 명령을 사용하십시오. `./ontap-mediator-1.11.0/ontap-mediator-1.11.0 -y --skip-code-signature-check`
