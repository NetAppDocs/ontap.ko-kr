...
+
또는,  `--https-only` 옵션을  `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y` 명령어에서 사용하여 HTTPS만 지정할 수 있습니다.
...
[NOTE]
====
설치 중 서명 확인을 건너뛰려면 다음 명령을 사용하십시오. `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
