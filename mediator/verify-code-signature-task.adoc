...
[NOTE]
====
* 2025년 6월 15일부터는 코드 서명 확인 인증서가 만료되었으므로 ONTAP Mediator 1.9 및 1.8을 설치하거나 업그레이드할 수 없습니다. 대신 ONTAP Mediator 1.11 또는 1.10을 설치하거나 업그레이드하십시오.
...
----
. 관련 인증서를 사용하여  `ontap-mediator-1.11.0.sig.tsr` 및  `ontap-mediator-1.11.0.tsr` 파일을 확인하십시오.
+
[role="tabbed-block"]
====
.오픈SSL 3.x
