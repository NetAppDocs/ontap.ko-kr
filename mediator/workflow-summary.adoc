...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["2개"]link:upgrade-host-os-mediator-task.html["호스트 OS 및 Mediator 업그레이드"]
[role="quick-margin-para"]
기존 ONTAP Mediator 버전을 업그레이드하는 경우, 먼저 이전 버전을 제거한 다음 새 버전을 설치해야 합니다. ONTAP Mediator를 처음 설치하는 경우에는 이 단계를 건너뛸 수 있습니다.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["6개"]link:install-mediator-pkg-task.html["ONTAP Mediator를 설치합니다"]
[role="quick-margin-para"]
