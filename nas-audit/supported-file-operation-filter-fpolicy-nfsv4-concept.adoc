...
---
= ONTAP의 NFSv4에 대해 지원되는 FPolicy 파일 작업 및 필터
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
ONTAP 9.19.1부터 관리자는 System Manager, CLI 또는 REST API를 사용하여 개별 스토리지 VM에 대해 프로토콜을 활성화 또는 비활성화함으로써 SVM 수준에서 NFSv4.2 가용성을 제어할 수 있습니다.
