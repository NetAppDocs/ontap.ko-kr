...
|===
이 절차에서 설명하는 명령 또는 link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-remove-ranges.html["네트워크 서브넷 범위를 제거합니다"^]명령에 대해 자세히 link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-add-ranges.html["네트워크 서브넷 추가 범위"^]알아보십시오.
