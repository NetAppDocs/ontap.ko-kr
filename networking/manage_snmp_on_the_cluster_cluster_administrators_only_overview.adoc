...
summary: 클러스터의 SVM을 모니터링하도록 SNMP를 구성하십시오. 
---
...
ONTAP 시스템의 SNMP 지원에 대한 자세한 내용은 https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf["TR-4220: Data ONTAP에서 SNMP 지원"^]을 참조하십시오.
