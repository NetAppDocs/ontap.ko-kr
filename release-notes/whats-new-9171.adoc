...
| 업데이트 | 설명 
 ...
 a| 
xref:../anti-ransomware/index.html[추가 하이퍼바이저 지원]
 a| 
ONTAP 9.17.1P5부터 Autonomous Ransomware Protection은 Hyper-V, KVM 및 OpenStack 하이퍼바이저를 지원합니다.



 a| 
xref:../anti-ransomware/index.html[자율형 랜섬웨어 보호 스냅샷 업데이트]
 a| 
ONTAP ARP/AI 스냅샷에 대한 몇 가지 업데이트를 도입했습니다.
