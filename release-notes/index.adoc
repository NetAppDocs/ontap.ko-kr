...
ONTAP 9.17.1은 보안 관리, 데이터 보호, S3 객체 스토리지 및 스토리지 관리 분야에서 새롭고 향상된 기능을 제공합니다. 새로운 기능 및 향상된 기능의 전체 목록은 다음을 참조하세요. xref:whats-new-9171.adoc[ONTAP 9.17.1의 새로운 기능] .
