...
| xref:../snaplock/snapshot-lock-concept.html#enable-snapshot-copy-locking-when-creating-a-volume[변조 방지 스냅샷 잠금] | System Manager를 사용하여 SnapLock가 아닌 볼륨의 스냅샷을 잠가 랜섬웨어 공격으로부터 보호할 수 있습니다. 
