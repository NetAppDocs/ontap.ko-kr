...
* 에이link:https://console.netapp.com/cloud-tiering["NetApp 클라우드 계층화 라이선스"] Alibaba Cloud Object Storage로 계층화하는 경우 필요합니다. 자세한 내용은 다음을 참조하세요. link:install-license-aws-azure-ibm-task.html["ONTAP 클러스터에 FabricPool 라이센스를 설치합니다"] .
