...
* Alibaba Cloud Object Storage로 계층화할 때는 link:https://console.netapp.com/cloud-tiering["NetApp 클라우드 계층화 라이선스"^]가 필요합니다. 자세한 내용은 link:install-license-aws-azure-ibm-task.html["ONTAP 클러스터에 FabricPool 라이센스를 설치합니다"]를 참조하십시오.
