...
* 온프레미스 ONTAP 클러스터에서 Azure Blob Storage로 계층화할 때 link:install-license-aws-azure-ibm-task.html["FabricPool 라이센스"]가 필요합니다.
* Cloud Volumes ONTAP 또는 Azure NetApp Files에서 Azure Blob Storage를 사용하는 경우 라이선스가 필요하지 않습니다.
