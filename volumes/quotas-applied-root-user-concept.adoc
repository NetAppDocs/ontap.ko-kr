...
summary: UNIX 클라이언트의 루트 사용자는 트리 할당량의 적용을 받지만 사용자 또는 그룹 할당량의 적용은 받지 않습니다. 따라서 루트 사용자는 할당량으로 인해 차단될 수 있는 작업을 다른 사용자를 대신하여 수행할 수 있습니다. 
---
= ONTAP 할당량이 루트 사용자에게 적용되는 방법에 대해 알아보십시오
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
