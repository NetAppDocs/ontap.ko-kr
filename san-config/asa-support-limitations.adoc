...
NOTE: 이러한 제한 사항은 ASA 시스템에 적용됩니다. ASA r2 시스템(ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 또는 ASA C30)을 사용하는 경우 link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["ASA R2 시스템 스토리지 제한"^]을 참조하십시오.
...
영구 포트에 대한 자세한 내용은 link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["NetApp 기술 보고서 4080: 최신 SAN에 대한 모범 사례"^]을 참조하십시오.
