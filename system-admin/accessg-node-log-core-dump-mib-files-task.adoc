...
summary: Service Processor Infrastructure 웹 서비스는 기본적으로 활성화되어 있어 웹 브라우저를 통해 클러스터 노드의 로그, 코어 덤프 및 MIB 파일에 액세스할 수 있습니다. 노드가 다운되더라도 파트너가 인수하면 파일에 계속 액세스할 수 있습니다. 
---
