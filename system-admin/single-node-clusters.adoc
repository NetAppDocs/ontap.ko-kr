...
summary: 단일 노드 클러스터는 독립형 노드에서 실행되는 클러스터의 특별한 구현 방식입니다. 단일 노드 클러스터는 이중화를 제공하지 않으므로 권장되지 않습니다. 노드에 장애가 발생하면 데이터 액세스가 불가능해집니다. 
---
...
.관련 정보
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["NetApp 기술 보고서 4684: NVMe-oF를 사용하여 최신 SAN 구현 및 구성"^]
