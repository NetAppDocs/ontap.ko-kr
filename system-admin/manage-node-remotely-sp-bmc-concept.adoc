...
summary: 서비스 프로세서 또는 베이스보드 관리 컨트롤러라고 하는 온보드 컨트롤러를 사용하여 노드를 원격으로 관리할 수 있습니다. 이 원격 관리 컨트롤러는 현재 모든 플랫폼 모델에 포함되어 있습니다. 이 컨트롤러는 노드의 작동 상태와 관계없이 항상 작동 상태를 유지합니다. 
---
