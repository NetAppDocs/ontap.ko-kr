...
summary: 클러스터 또는 SVM 수준에서 오늘의 메시지를 관리할 수 있습니다. 기본적으로 클러스터에 대해 구성된 MOTD는 모든 SVM에 대해서도 활성화됩니다. 또한 각 SVM에 대해 SVM 수준 MOTD를 구성할 수 있습니다. 클러스터 수준 MOTD는 클러스터 관리자가 각 SVM에 대해 활성화 또는 비활성화할 수 있습니다. 
---
