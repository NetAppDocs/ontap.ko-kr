...
+
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html["AFF A-Series 시스템"^]
** link:https://docs.netapp.com/us-en/ontap-systems/aff-cseries/index.html["AFF C-Series 시스템"^]
...
[NOTE]
====
설정 GUI를 사용하여 클러스터를 설정하는 방법에 대한 자세한 내용은 link:../task_admin_add_nodes_to_cluster.html["노드 관리 문서"]를 참조하십시오.  `cluster setup`에 대해 자세히 알아보려면 link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["ONTAP 명령 참조입니다"^]를 참조하십시오.
