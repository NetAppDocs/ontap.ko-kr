...
[NOTE]
====
설정 GUI를 사용하여 클러스터를 설정하는 방법에 대한 자세한 내용은 온라인 도움말을 참조하십시오link:https://docs.netapp.com/us-en/ontap/manage-nodes-sm-task.html["시스템 관리자"]. 에 대한 자세한 내용은 `cluster setup` link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["ONTAP 명령 참조입니다"^]을 참조하십시오.
