...
summary: NetApp 라이선스 파일과 라이선스 키는 System Manager를 사용하여 설치할 수 있으며, 이는 NLF 설치에 권장되는 방법입니다. 또는 ONTAP CLI를 사용하여 라이선스 키를 설치할 수도 있습니다. ONTAP 9.10.1 이상에서는 NetApp 라이선스 파일을 사용하여 기능이 활성화되고, ONTAP 9.10.1 이전 릴리스에서는 라이선스 키를 사용하여 ONTAP 기능이 활성화됩니다. 
---
