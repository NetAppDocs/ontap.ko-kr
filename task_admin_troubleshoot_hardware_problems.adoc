...
---
= ONTAP System Manager를 사용하여 하드웨어 문제를 해결합니다
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.2+| 플랫폼 11+| ONTAP 버전의 System Manager에서 지원됨... 


| 9.18.1 | 9.17.1 | 9.16.1 | 9.15.1 | 9.14.1 | 9.13.1 | 9.12.1 | 9.11.1 | 9.10.1 | 9.9.1 | 9.8(미리보기 모드만 해당) 
...
| ONTAP 9.10.1 및 9.9.1 | Cisco Nexus 3232C
