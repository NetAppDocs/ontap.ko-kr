...
.이 작업에 대해
이 절차는 다음 사항에 적용됩니다. link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF, ASA FAS"^] 그리고 link:https://docs.netapp.com/us-en/ontap-afx/index.html["AFX 시스템"^]. ASA R2 시스템(ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 또는 ASA C30)을 사용 중인 경우 다음 단계를 따르십시오. link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["수행할 수 있습니다"^] 시스템 관리자를 사용하여 ONTAP 클러스터를 설정합니다. ASA r2 시스템은 SAN 전용 고객을 위해 간소화된 ONTAP 환경을 제공합니다.
