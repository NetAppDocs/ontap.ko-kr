...
표준 S3 NAS 버킷에서 지원되는 S3 작업은 FlexCache S3 NAS 버킷에서도 지원되지만 `COPY` 작업은 예외입니다. 표준 S3 NAS 버킷에서 지원되지 않는 작업의 최신 목록은 link:../s3-multiprotocol/index.html#s3-and-nas-interoperability["상호 운용성 문서"]를 참조하십시오.
